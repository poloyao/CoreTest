...
namespace WebCore
{
    public class NASDK
    {
        ...
        private string m_logfile = "wk_na.txt";
        private string m_pltip;
        private string m_appid;
        private string m_appsecret;
        private int m_pltPort;
        private string m_p12certfile;
        ...
        public HistoryDataResult queryHistoryData(string token, string deviceId, string gatewayid, string serviceId, string property, int pageno, int pagesize, string starttime, string endtime)
        {
            ...
            string apiPath = string.Format($"/iocm/app/data/v1.2.0/deviceDataHistory?deviceid={deviceId}&gatewayid={gatewayid}&appid={m_appid}&serviceid={serviceId}&property={property}&pageno={pageno}&pagesize={pagesize}&starttime={starttime}&endtime={endtime}");
